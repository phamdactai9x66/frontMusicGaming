...
const CategoryDetailPlaylist: React.FC<CategoryDetailPlaylist<any>> = ({ match, ...props }) => {
    // console.log(window.location.href);
    const test1 = new URL(window.location.href);
    const test2 = new URLSearchParams(test1.search);
    console.log(test2.get('idTopic'))
    return (
        <>
