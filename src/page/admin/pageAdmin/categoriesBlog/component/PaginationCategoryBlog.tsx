...
interface PaginationCategoryBlog<T> {
  state: any,
  dispatch: any
}

const PaginationCategoryBlog: React.FC<PaginationCategoryBlog<any>> = ({ state, dispatch, ...props }) => {
...
export default PaginationCategoryBlog
